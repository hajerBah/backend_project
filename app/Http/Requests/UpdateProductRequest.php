...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            //'settings.*.main_picture' => 'required|string',
    ...
    public function messages()
    {
        return [
            ...
            'settings.*.main_picture.required' => 'The main picture field is required for each setting.',
            'settings.*.main_picture.string' => 'The main picture must be a string.',
